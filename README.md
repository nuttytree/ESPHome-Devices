...
### [Fire Pit and Fountain](./fire-pit-fountain.yaml)
...
### [Garage Fridge](./garage-fridge.yaml)
...
### [Water Heater](./water-heater.yaml)
...
* [Basement Fridge](./basement-fridge.yaml)
* [Basement TV](./basement-tv.yaml)
* [Family Room TV](./family-room-tv.yaml)
* [Kitchen Fridge](./kitchen-fridge.yaml)
* [Network Equipment](./network-equipment.yaml)
* [Sump Pump](./sump-pump.yaml)
* [Washing Machine](./washing-machine.yaml)
...
* [Basement Bathroom Shower Light and Heater](./basement-bath-shower-light-heat.yaml)
...
* [Garage Lights](./garage-lights.yaml)
...
* [Main Garage Door](./main-garage-door.yaml) — v2.5i board variant connected to a Chambelain MyQ opener
* [Second Garage Door](./second-garage-door.yaml) — dry-contact variant connected to an old opener
...
* [Basement Bluetooth Proxy](./bt-proxy-basement.yaml)
