...
PUMP_SWITCH_CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Required(
            CONF_MAX_OUT_OF_RANGE_DURATION
...
async def to_code(config):
    ...
    cg.add(
        var.set_pump_current_monitoring(
            pump_current,
            pump_config[CONF_MIN_CURRENT],
            pump_config[CONF_MAX_CURRENT],
            pump_config[CONF_MAX_OUT_OF_RANGE_DURATION],
        )
    )
    ...
    cg.add(
        var.set_cleaner_current_monitoring(
            cleaner_current,
            cleaner_config[CONF_MIN_CURRENT],
            cleaner_config[CONF_MAX_CURRENT],
            cleaner_config[CONF_MAX_OUT_OF_RANGE_DURATION],
        )
    )
